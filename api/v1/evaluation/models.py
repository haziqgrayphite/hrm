...
class Parameter(GrayphiteBaseModel):
    ...
    parameter_rating = models.ForeignKey(ParameterRating, on_delete=models.NOT_PROVIDED, null=True, blank=True)
...
class BaseEvaluation(GrayphiteBaseModel):
    ...
    parameters = models.ForeignKey(Parameter, on_delete=models.CASCADE, related_name="base_evaluation_parameter")
